package com.jpa.ecommerce.hibernate;
...
public class EcmMachineMultiTenantConnectionProvider implements
    ...
    public void start() {
        ...
        configTenant("jpa_ecommerce",
                "jdbc:mysql://localhost/jpa_ecommerce?" +
                        "createDatabaseIfNotExist=true&useTimezone=true&serverTimezone=UTC",
                "root",
                "root");

        configTenant("store_ecommerce",
                "jdbc:mysql://localhost/jpa_store_ecommerce?" +
                        "createDatabaseIfNotExist=true&useTimezone=true&serverTimezone=UTC",
                "root",
                "root");
    ...
    private void configTenant(String tenant, String url, String user, String password) {
